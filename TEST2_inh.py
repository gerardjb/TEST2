...
janelia_file = 'test'
filename = "/scratch/gpfs/gerardjb/TEST2/sample_data/output/sim4fig3/test_inh.mat"
...
constants_file="sample_data/constants_GCaMP_inhib.json"
output_folder="sample_data/output"
column=1
tag="default_janelia_sample_inhibitory2" #inhibitory" #excitatory"
